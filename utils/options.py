...
def parse_options(root_path, is_train=True):
    ...
    parser.add_argument('-expe', type=str, required=True, help='Path to experiment YAML file.')
    ...
    # parse yml to dict
    with open(args.expe, mode='r') as f:
        opt = yaml.load(f, Loader=ordered_yaml()[0])
    with open(args.task, mode='r') as f:
        task = yaml.load(f, Loader=ordered_yaml()[0])
